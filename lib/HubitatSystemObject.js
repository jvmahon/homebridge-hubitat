			...
			.on('message', function (data)
				{
					...
					if (receivedData.source == "DEVICE")
					{
						...
						for(var thisObject of that.Devices[receivedData.deviceId].notifyObjects)
						{
							...
							{
								that.log(chalk.yellow(`Received from device id: ${chalk.cyan(receivedData.deviceId)} a data value ${chalk.cyan(receivedData.value)} in report type ${chalk.cyan(thisObject.reportType)} with Name ${chalk.cyan(receivedData.displayName)}.`));
